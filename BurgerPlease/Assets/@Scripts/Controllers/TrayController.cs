...
public class TrayController : MonoBehaviour
{
	...
	public int ReservedCount => _reserved.Count; // 쟁반 위로 이동중인 아이템 개수
	public int TotalItemCount => _reserved.Count + _items.Count; // 쟁반 위로 이동중인 아이템을 포함함 전체 개수
