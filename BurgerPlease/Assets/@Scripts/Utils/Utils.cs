...
public static class Utils
{
	...
	public static string GetMoneyText(long money)
	{
		...
		if (money < 1000000) return (money / 1000f).ToString("0.##")  + "k";
		if (money < 1000000) return (money / 1000000f).ToString("0.##") + "m";
		if (money < 1000000000) return (money / 1000000000f).ToString("0.##") + "b";
